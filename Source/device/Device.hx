...
{	
	...
	public function new() 
	{
		if (Engine.instance != null) {
			...
			var defaultShader = new ShaderProgram (DEFAULT_SHADER_NAME, "default", "default", ["aVertexPosition", "aVertexNormal", "aVertexColor"], ["uProjectionMatrix", "uModelMatrix", "uViewMatrix", "uLightPos"]);
